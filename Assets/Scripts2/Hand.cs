...
public class Hand : MonoBehaviour
{
    ...
    public GameObject horrorArea;
    public GameObject horrorWall;
    public GameObject horrorRoof;
    ...
    void Start()
    {
        ...
        horrorWall.GetComponent<BoxCollider>();
    }
    void Update()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.transform.name == "HorrorPad")
        {
            Debug.Log("got it");
            horrorArea.SetActive(true);
            //gorillaRig.transform.position = new Vector3(-987.063965f, 0.699731827f, -13.0733614f);
            parkourArea.SetActive(false);
        ...
        {
            Enemy1.GetComponent<Enemy>().Chase();
        }
        if (other.transform.name == "HorrorFloor")
        {
            Debug.Log("got it");
            horrorWall.GetComponent<BoxCollider>().enabled = true;
            horrorRoof.transform.position = new Vector3(-1000, 2, 0);
        }
        if (other.tag == "Red")
        {
